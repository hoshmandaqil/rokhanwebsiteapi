...
class LeadershipMessagesRelationManager extends RelationManager
{
    ...
    {
        return LeadershipMessageForm::configureForDepartmentRelation($schema, (int) $this->getOwnerRecord()->getKey());
    }

    public function table(Table $table): Table
    {
        return $table
            ->modifyQueryUsing(fn ($query) => $query->where('type', LeadershipMessageType::Department))
            ->headerActions([
                LocaleSwitcher::make(),
            ]);
    }
